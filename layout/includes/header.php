...
// Main navbar.
if (
    isset($PAGE->theme->settings->stickynavbar) && $PAGE->theme->settings->stickynavbar == 1
...
<head>
    ...
    ?>
        <!-- Load Google Fonts -->
        <link href='https://fonts.googleapis.com/css?family=<?php echo $fontname . $fontweight . $fontssubset; ?>' rel='stylesheet' type='text/css'>
    <?php
    }
    ?>
    ...
    ?>
        <link href='https://fonts.googleapis.com/css?family=<?php echo $fontheadername . $fontheaderweight . $fontssubset; ?>' rel='stylesheet' type='text/css'>
    <?php
    }
    ?>
    ...
    ?>
        <link href='https://fonts.googleapis.com/css?family=<?php echo $fonttitlename . $fonttitleweight . $fontssubset; ?>' rel='stylesheet' type='text/css'>
    <?php
    }
    ?>
</head>
...
<body <?php echo $OUTPUT->body_attributes(array(
            'two-column', $setzoom, 'header-' . $adaptableheaderstyle,
                                ...
                                <ul class="navbar-nav ml-auto my-auto">
                                    ...
                                    ?>
                                            <form id="pre-login-form" class="form-inline my-2 my-lg-0" action="<?php p($wwwroot) ?>/login/index.php" method="post">
                                                ...
                                                <input type="text" name="username" placeholder="<?php echo get_string('loginplaceholder', 'theme_adaptable'); ?>" size="11">
                                                <input type="password" name="password" placeholder="<?php echo get_string('passwordplaceholder', 'theme_adaptable'); ?>" size="11">
                                        ...
                                        ?>
                                            <form id="pre-login-form" class="form-inline my-0 my-lg-1" action="<?php p($wwwroot) ?>/login/index.php" method="post">
                                                <input type="hidden" name="logintoken" value="<?php echo s(\core\session\manager::get_login_token()); ?>" />
                                        ...
                                        <?php
                                        } else if ($PAGE->theme->settings->displaylogin == 'alternativeurl') {
                                        ?>
                                            <a class="btn-login" href="<?php echo $PAGE->theme->settings->alternateloginurl; ?>">
                                                <?php echo get_string('logintextbutton', 'theme_adaptable'); ?>
                                            </a>
                                        <?php
                                        }
                                ...
                                <div class="searchbox d-none d-lg-block">
                                    <form action="<?php echo $wwwroot; ?>/course/search.php">
                                        ...
                                        <div class="search-box grey-box bg-white clear-fix">
                                            <input placeholder="<?php echo get_string("searchcourses", "theme_adaptable"); ?>" accesskey="6" class="search_tour bg-white no-border left search-box__input ui-autocomplete-input" type="text" name="search" id="search-1" autocomplete="off">
                                            <button title="<?php echo get_string("searchcourses", "theme_adaptable") ?>" type="submit" class="no-border bg-white pas search-box__button">
                                        ...
                                        <ul class="navbar-nav ml-auto">
                                            ...
                                            if (!isloggedin() || isguestuser()) {
                                                ...
                                                if ($PAGE->theme->settings->displaylogin == 'box') {
                                                    // Login button.
                                            ?>
                                                    <form id="pre-login-form" class="form-inline my-auto m-1" action="<?php p($wwwroot) ?>/login/index.php" method="post">
                                                        <input type="hidden" name="logintoken" value="<?php echo s(\core\session\manager::get_login_token()); ?>" />
                                                        <input type="text" name="username" placeholder="<?php echo get_string('loginplaceholder', 'theme_adaptable'); ?>" size="11">
                                                        <input type="password" name="password" placeholder="<?php echo get_string('passwordplaceholder', 'theme_adaptable'); ?>" size="11">
                                                        <button class="btn-login" type="submit"><?php echo get_string('logintextbutton', 'theme_adaptable'); ?>
                                        ...
                                        if (isloggedin()) {
                                            if (!empty($this->page->theme->settings->enableshowhideblocks)) {
                                                ...
                                                echo html_writer::start_tag(
                                                    'div',
                                                    array(
                                                        'id' => 'zoominicon', 'class' => $zoomside . ' nav-link', 'title' => $zoominicontitle,
